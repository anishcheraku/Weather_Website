...
function displayCurrentData(data) {
    ...
    todayTemperature.innerHTML = data.current.temp_f;
...
function displayNextData(data) {
    ...
    nextDayMorningTemp.innerHTML = "High: " + arr.day.maxtemp_f + '&#176;F';
    nextDayEveningTemp.innerHTML = "Low: " + arr.day.mintemp_f + '&#176;F';
    nextDayConditionDesc.innerHTML = "Condition: " + arr.day.condition.text;
...
function displayLastData(data) {
    ...
    nextDayConditionImg.setAttribute('src',"https:" + arr.day.condition.icon);
    lastDayMorningTemp.innerHTML = "High: " + arr.day.maxtemp_f + '&#176;F';
    lastDayEveningTemp.innerHTML = "Low: " + arr.day.mintemp_f + '&#176;F';
    lastDayConditionDesc.innerHTML = "Condition: " + arr.day.condition.text;
...
async function sequenceFunctions(city='Atlanta') {
